...
export function SectionSkeleton() {
  return (
    <section className="bg-[#0a0a0a] min-h-screen flex flex-col justify-center px-6 py-20">
      <div className="max-w-350 mx-auto w-full space-y-6 animate-pulse">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 rounded-2xl overflow-hidden" style={{ minHeight:480 }}>
          ...
          <div className="bg-p-10 space-y-6">
        ...
        <div className="flex gap-4">
          {[1,2,3,4,5].map(i => (
            <div key={i} className="rounded-xl bg-white/5 shrink-0" style={{ width:180, height:110 }}/>
          ))}
        </div>
      </div>
    </section>
